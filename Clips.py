...
class Clips:
    ...
    def render(self, surface, tp, mouse_pos):
        ...
        self.rect_view_pos = (
        (-1*self.world.background_pos.x/self.a)+self.size[0]-self.minimap_size[0]+((self.size[0]/5)/self.a),
        ...
        self.size[0]-self.minimap_size[0], self.size[1]-self.minimap_size[1], self.minimap_size[0],
